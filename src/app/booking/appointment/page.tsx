...
export default function SelectSlotPage() {
  ...
  const chipBase =
    "inline-flex items-center justify-center px-4 py-2 rounded-full border text-sm cursor-pointer transition-colors duration-150 disabled:opacity-35 disabled:cursor-not-allowed";
  const chipInactive = "border-border bg-muted/20 text-muted-foreground hover:border-primary/35 hover:text-foreground";
  const chipActive = "border-primary/50 bg-primary/15 text-primary";
