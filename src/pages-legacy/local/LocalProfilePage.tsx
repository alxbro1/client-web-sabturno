...
import { Local } from "@/lib/types/local";
    ...
    <section className="grid gap-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="border border-white/12 bg-[linear-gradient(180deg,rgba(22,22,22,0.96),rgba(12,12,12,0.95))] rounded-[28px] shadow-[0_16px_40px_rgba(0,0,0,0.34)] p-6 space-y-5">
          <h3 className="text-lg font-semibold text-white">Informacion del negocio</h3>

          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Nombre del local *</label>
              <input
                type="text"
                value={formData.name}
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Email de contacto *</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Telefono</label>
              <input
                type="tel"
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Provincia *</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Ciudad *</label>
              <input
                type="text"
                value={formData.city}
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-white/80 mb-2">Direccion *</label>
              <input
                type="text"
