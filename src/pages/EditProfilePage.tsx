...
export function EditProfilePage() {
  ...
  return (
    <section className="grid gap-6">
      ...
      <form className="border border-white/12 bg-[linear-gradient(180deg,rgba(22,22,22,0.96),rgba(12,12,12,0.95))] rounded-[28px] shadow-[0_16px_40px_rgba(0,0,0,0.34)] backdrop-blur-[12px] p-5 grid gap-4" onSubmit={handleSubmit}>
        ...
        <label className="grid gap-[0.45rem]">
          <span className="text-[0.86rem] font-semibold tracking-[0.04em] text-white/88">Imagen de perfil</span>
          <input
            type="file"
            accept="image/*"
